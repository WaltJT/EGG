...
import eje6.Extrahotel.Camping;
import eje6.Extrahotel.Residencia;
import eje6.Hotel.HotelCinco;
import eje6.Hotel.HotelCuatro;
...
public class Servicio {
                ...
                case 4:
                    for (Alojamiento hotele : hoteles) {
                        if(hotele instanceof Residencia){
                            if(((Residencia) hotele).isDescuento()){
                                hotele.info();
                            }
                        }
                    }
    ...
    public ArrayList<Alojamiento> crearHoteles(int a){
        ...
        for (int i = 0; i < a; i++) {
            ...
            switch(aux){
                case 1:
                    lista.add(new HotelCuatro());
                    break;
                case 2:
                    lista.add(new HotelCinco());
                    break;
                case 3:
