...
public void cantPersonas(){
        ...
        int personasPorPiso = personasPorOficina * numOficinas;
        int personasTotales = personasPorPiso * numPisos;

        System.out.println("Personas por piso: " + personasPorPiso);
        System.out.println("Personas en todo el edificio: " + personasTotales);
