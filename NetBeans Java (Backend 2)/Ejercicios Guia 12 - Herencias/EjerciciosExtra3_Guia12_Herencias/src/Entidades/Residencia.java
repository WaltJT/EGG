...
public class Residencia extends AlojamientoExtrahotelero {
    ...
    public void info() {
        ...
        System.out.println("Descuento para gremio: " + descuentoGremios);
        System.out.println("Campo deportivo: " + tieneCampoDeportivo);
        System.out.println("----------");
    }
    ...
    public void crearAlojamiento() {
        ...
        cantidadHabitaciones = (int)(Math.random()*50);
        cantidadHabitaciones += 10;
        switch((int)(Math.random()*2)){
            case 0:
                descuentoGremios = true;
                break;
            case 1:
                descuentoGremios = false;
                break;
        }
        switch((int)(Math.random()*2)){
            case 0:
                tieneCampoDeportivo = true;
                break;
            case 1:
                tieneCampoDeportivo = false;
                break;
        }
        precio();
    }
    ...
    public void precio() {
        ...
        precioHab+=cantidadHabitaciones;
        Value = precioHab;
