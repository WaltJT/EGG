...
public class ClaseMainHashSet {

    public static void main(String[] args) {
        Scanner leer = new Scanner(System.in);
    
        PersonaServicioHashSet nuevaEjecucion = new PersonaServicioHashSet(); // Llamo a mi clase SERVICIO para acceder a los metodos correspondientes
