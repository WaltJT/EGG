...
public class Persona {
    ...
    public Persona(String nombre, String apellido, int edad, double estatura, int peso) {
        this.nombre = nombre;
    ...
    public String toString() {
        return "Persona{" + "scanner=" + scanner + ", nombre=" + nombre + ", apellido=" + apellido + ", edad=" + edad + ", estatura=" + estatura + ", peso=" + peso + '}';
    }
