...
public class Dia5_Ejercicio7 {
    ...
    int contarCorrectas,contarIncorrectas;
    ...
    while (true) {
        ...
        System.out.println("Por favor ingrese por pantalla "
                + "una cadena maxima de 5 caracteres (recuerde tener en cuenta "
                + "que la primer letra debe ser una X y la ultima una O): ");
