 ...
 */
package Dia26_Ejercicio4_Final;
...
public class Dia26_Ejercicio4_Final {
    ...
    FechaServicios fechaService = new FechaServicios(scanner);
        ...
        Fecha fechaNacimiento = fechaService.fechaNacimiento();
        ...
        int edad = fechaService.diferencia(fechaNacimiento, new Fecha(fechaActual.getDate(), fechaActual.getMonth() + 1, fechaActual.getYear() + 1900));
